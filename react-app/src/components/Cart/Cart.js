    ...
    if (cart.products) {
      ...
      cart.products.forEach((product) => {
        ...
        if (
          ...
          !errors.includes(
            `You have too many ${product.product.name
              .split(" ")
              .slice(0, 6)
              .join(" ")} in your cart.`
          )
          ...
          <div className="cart-items-wrapper">
            ...
            <div className="sidebar-main-wrapper">
              <div className="sidenav">
                ...
                <div className="sb-shipping">Shipping:</div>
                <div className="radio-shipping">
                  <input type="radio" value="Standard" name="shipping" />{" "}
                  Standard Shipping: Free
                  <input type="radio" value="Express" name="shipping" />{" "}
                  Express: $10.00
                  <input type="radio" value="OverNight" name="shipping" /> Over
                  Night: $20.00
                </div>

                <div className="sb-total">Grand Total: ${total}</div>
                {errors.length > 0 && (
                  <ul>
                    {errors.map((error) => (
                      <li>{error}</li>
                ...
                {!errors.length && (
                  <div id="checkout-btn" onClick={completeOrder}>
                    Proceed to Checkout
                  </div>
                )}
              </div>
