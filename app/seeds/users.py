...
def seed_users():
    ...
    user1 = User(
        ...
        username="Noemy34",
        address="3343 Breanne Green Apt. 660",
        hashed_password="zfeMR_6S2TXLf5m",
    )
    ...
    user2 = User(
        ...
        hashed_password="tKDL5DQ0oJ6AGUc",
    )
    ...
    user3 = User(
        ...
        hashed_password="TFSUKGohududev6",
    )
    ...
    user4 = User(
        ...
        hashed_password="YEcHlclhFWZSLMx",
    )
    ...
    user5 = User(
        ...
        hashed_password="7_yzUQQLCYp_o5t",
    )
